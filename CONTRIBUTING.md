...
All bug fixes and new features should go to the [`main`](https://github.com/gemini-testing/hermione-codemod/tree/main) branch.
...
1. [Search](https://github.com/gemini-testing/hermione-codemod/issues) for same issues on github in order to prevent duplicates
