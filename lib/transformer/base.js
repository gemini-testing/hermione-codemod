...
const {FN_TYPES, DEFAULT_OPTIONS, BROWSER_NAME_OPTION} = require('../constants');
...
module.exports = class BaseTransformer {
    ...
    toSource() {
        ...
        return this._root.toSource(this._options.printOptions);
    }

    _prepareOptions(opts) {
        return _(opts)
            .defaults(DEFAULT_OPTIONS)
            .mapValues(o => _.isString(o) && o.includes(',') ? o.split(',') : o)
            .value();
    }
